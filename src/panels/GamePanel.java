...
public class GamePanel extends JPanel {
	...
	// 리스트 생성
	private List<Coin> jellyList; // 젤리 리스트
	...
	public GamePanel(JFrame superFrame, CardLayout cl, Object o) {
		...
		// 일시정지 버튼
		escButton = new JButton("돌아가기");
		escButton.setBounds(550, 400, 100, 30);
	...
	protected void paintComponent(Graphics g) {
		...
		// 배경이미지
		buffg.drawImage(b11.getImage(), 0, 0, b11.getWidth(), b11.getHeight() * 5 / 4, null);
		buffg.drawImage(b12.getImage(), 0, 0, b12.getWidth(), b12.getHeight() * 5 / 4, null);
//		buffg.drawImage(b21.getImage(), 0, 0, b21.getWidth(), b21.getHeight() * 5 / 4, null);
//		buffg.drawImage(b22.getImage(), 0, 0, b22.getWidth(), b22.getHeight() * 5 / 4, null);
		...
		for (int i = 0; i < jellyList.size(); i++) {
			...
			Coin tempJelly = jellyList.get(i);

			if (tempJelly.getX() > -90 && tempJelly.getX() < 1200) {
...
//		buffg.drawImage(slideBtn, 650, 360, 132, 100, null);
	...
	private void makeMo() {
		...
		mo1 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back4.png"),
		...
		mo2 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back4.png"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map2img/field2.png"),
				new ImageIcon("img/Objectimg/map1img/enemy1.gif"), new ImageIcon("img/Objectimg/map2img/tacle2.png"),
				new ImageIcon("img/Objectimg/map2img/tacle3.png"), new ImageIcon("img/Objectimg/map2img/tacle3.png"));

		mo3 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back4.png"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map3img/field2.png"),
				new ImageIcon("img/Objectimg/map1img/enemy1.gif"), new ImageIcon("img/Objectimg/map3img/tacle2.png"),
				new ImageIcon("img/Objectimg/map3img/tacle3.png"), new ImageIcon("img/Objectimg/map3img/tacle3.png"));

		mo4 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back4.png"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"),
				new ImageIcon("img/Objectimg/map4img/ffootTest2.png"),
				new ImageIcon("img/Objectimg/map1img/enemy1.gif"), new ImageIcon("img/Objectimg/map4img/tacle2.png"),
		...
		for (int i = 0; i < maxX; i += 1) { // 젤리는 1칸을 차지하기 때문에 1,1사이즈로 반복문을 돌린다.
			for (int j = 0; j < maxY; j += 1) {
				if (colorArr[i][j] == 16776960) { // 색값이 16776960일 경우 기본젤리 생성
					...
					jellyList.add(new Coin(jelly1Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 1234));

				} else if (colorArr[i][j] == 13158400) { // 색값이 13158400일 경우 노란젤리 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					jellyList.add(new Coin(jelly2Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 2345));

				} else if (colorArr[i][j] == 9868800) { // 색값이 9868800일 경우 분홍젤리 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					jellyList.add(new Coin(jelly3Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 3456));

				} else if (colorArr[i][j] == 16737280) { // 색값이 16737280일 경우 생명(하트) 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					jellyList.add(new Coin(jellyHPIc.getImage(), i * 40 + mapLength * 40, j * 40, 60, 50, 255, 4567));
				}
			}
		}
	...
	private void initListener() {
		addKeyListener(new KeyAdapter() { // 키 리스너 추가
			...
			public void keyPressed(KeyEvent e) {
				...
				if (!escKeyOn) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER) {// 엔터 키를 누르고 더블점프가 2가 아닐때
			...
			public void run() {
				while (true) {
					...
					if (foot > 1999 || heartCount < 1) { // 게임 오버
						main.getEndPanel().setResultScore(resultScore); // 여기에서 최종 점수 가져가면 됨!!
...
//					b22.setX(b22.getX() - gameSpeed * 2 / 3);
					...
					for (int i = 0; i < jellyList.size(); i++) {
						...
						Coin tempJelly = jellyList.get(i); // 임시 변수에 리스트 안에 있는 개별 젤리를 불러오자
